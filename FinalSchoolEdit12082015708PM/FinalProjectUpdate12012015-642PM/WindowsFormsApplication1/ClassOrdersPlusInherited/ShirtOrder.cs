...
namespace OrderEmployeedManagementWindowsNative.ClassOrdersPlusInherited
{
    class ShirtOrder : OrdersESP
    {
        public ShirtOrder(/*Shirt Specific Constructors*/  
            string itemIDCons, string orderTypeC, string materialC, decimal screenPrintPricePer, decimal screensNeeded,
            ...
            /*cost/Balance constructor values */decimal taxC, decimal amountCollected,  
             decimal margin, decimal labor/*end cost & base*/)
            //Base ConstructorItemsBelow
            :base( employeeIDCon, orderInitiated, dateDueC, descriptionNotesC, taxC, amountCollected,  
             margin, labor)
        {
            /*
             * ItemID;
